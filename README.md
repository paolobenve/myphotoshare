...
### version 2.6 (August 15, 2017):

* new option `video_crf` for video quality
* new option `cache_album_subdir`: the subdir of cache_path where the album composite images will be saved; these images are now generated by scanner and they are static
