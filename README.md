...
The scanner isn't able to add gps data if json files where generated by pre-gps (<= 2.8) versions: you must manually delete all the json files in cache folder in order to get them with all the needed data
